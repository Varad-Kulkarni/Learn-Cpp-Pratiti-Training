...
int main() {
	Derived u; // invokes compiler supplied derived default constructor of Derived class
	Derived v = u; // invokes compiler supplied derived copy constructor of Derived class
	v = u; // invokes compiler supplied derived copy assignment operator of Derived class
}
